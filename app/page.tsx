...
export default async function Home() {
  ...
  async function submitToCap(formData: FormData) {
    ...
    actionCookieStore.set(
      ...
      JSON.stringify({ result: evaluation, communityId }),
      {
        httpOnly: true,
        maxAge: 3,
        path: "/",
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-slate-900 text-white">
      ...
      <div className="w-full max-w-sm text-center">
        ...
        <h1 className="text-2xl font-bold">Javier Saeta</h1>
        <p className="text-slate-400 mb-6">SAP Consultant</p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <form action={submitToCap}>
            <input type="hidden" name="communityId" value="Javier_Saeta" />
